...
<!-- Start Video Section -->
<div id="video-section" class="video-section dark-section" style="padding-top:200px; padding-bottom:200px;" data-poster="{!! asset('video/video-1.jpg') !!}">
    <!-- Html5 Video Background -->
	<div class="fullscreen-video">
    	<video preload="auto" autoplay="" loop="" muted="muted">
            <source src="{!! asset('video/video-1.mp4') !!}" type="video/mp4">
            <source src="{!! asset('video/video-1.webm') !!}" type="video/webm">
            <source src="{!! asset('video/video-1.ogv') !!}" type="video/ogg">
        </video>
    </div>
	...
	<div class="container text-center">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <i class="accent-color icon-video2" style="font-size:5em;"></i>
                <h1 class="fit-text">Section Video</h1>
