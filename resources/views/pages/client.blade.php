			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-10 col-sm-offset-1 white-font-color  text-center wow fadeInUp animated">
						<div class="client-say">Our Clients</div>
					</div>
				</div>
			</div>
		</div>
...
<div class="container client">
	<div class="row">
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/fujitsu.png') }}" class="res-img" alt="">
			<hgroup>
		...
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/gm.png') }}" class="res-img" alt="">
			<hgroup>
		...
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/emerson.png') }}" class="res-img" alt="">
			<hgroup>
	...
	<div class="row">
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/cerebos.png') }}" class="res-img" alt="">
			<hgroup>
		...
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/samsung.png') }}" class="res-img" alt="">
			<hgroup>
		...
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/slab.png') }}" class="res-img" alt="">
			<hgroup>
	...
	<div class="row">
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/srab.png') }}" class="res-img" alt="">
			<hgroup>
				<h4>Summit Auto Body Industry</h4>
				<small>บริษัท ซัมมิท แหลมฉบัง โอโต บอดี้ เวิร์ค จำกัด</small>
			</hgroup>
		...
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/tokai.png') }}" class="res-img" alt="">
			<hgroup>
		...
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/sji.png') }}" class="res-img" alt="">
			<hgroup>
	...
	<div class="row">
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/takahata.png') }}" class="res-img" alt="">
			<hgroup>
		...
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/tft.png') }}" class="res-img" alt="">
			<hgroup>
		...
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/amaka.png') }}" class="res-img" alt="">
			<hgroup>
	...
	<div class="row">
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/sumitomo.png') }}" class="res-img" alt="">
			<hgroup>
		...
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/teknia.png') }}" class="res-img" alt="">
			<hgroup>
		...
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/wellpack.png') }}" class="res-img" alt="">
			<hgroup>
	...
	<div class="row">
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/yamahatsu.png') }}" class="res-img" alt="">
			<hgroup>
		...
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/titan.png') }}" class="res-img" alt="">
			<hgroup>
		...
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/dhl.png') }}" class="res-img" alt="">
			<hgroup>
	...
	<div class="row">
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/brand.png') }}" class="res-img" alt="">
			<hgroup>
				<h4>Brand (1835)</h4>
		...
		<div class="col-md-4 text-center">
			<img src="{{ asset('img/logo/kobelco.png') }}" class="res-img" alt="">
			<hgroup>
